...
# Usage: mpirun -np 2 python3 MonteCarloIntegration.py
...
def main():
    ...
    # Compute local contribution to the integral
    local_result = monte_carlo_integration(
        target_function, lower_limit, upper_limit, local_num_samples, rank
    )
